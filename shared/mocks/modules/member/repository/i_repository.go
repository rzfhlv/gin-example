...
func (_m *IRepository) Create(ctx context.Context, member model.Member) (sql.Result, error) {
	ret := _m.Called(ctx, member)

	var r0 sql.Result
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, model.Member) (sql.Result, error)); ok {
		return rf(ctx, member)
	}
	if rf, ok := ret.Get(0).(func(context.Context, model.Member) sql.Result); ok {
		r0 = rf(ctx, member)
	} else {
		if ret.Get(0) != nil {
...
func (_m *IRepository) Get(ctx context.Context, _a1 param.Param) ([]model.Member, error) {
	...
	var r0 []model.Member
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, param.Param) ([]model.Member, error)); ok {
		return rf(ctx, _a1)
	}
...
func (_m *IRepository) GetByID(ctx context.Context, id int64) (model.Member, error) {
